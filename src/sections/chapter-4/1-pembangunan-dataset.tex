...
\begin{filecontents*}{4.1.original-dataset.csv}
  ...
  ,\makecell[l]{AMR 3.0 Train},\makecell[r]{55,635},\checkmark{},\checkmark{},
...
\begin{filecontents*}{4.1.total-dataset-count.csv}
  ...
  \makecell[l]{Train},\makecell[l]{PANL-BPPT},\makecell[r]{24,024},\makecell[r]{224,220}
  ,\makecell[l]{IWSLT17},\makecell[r]{107,329},
  ,\makecell[l]{AMR 3.0 Train},\makecell[r]{92,867},
